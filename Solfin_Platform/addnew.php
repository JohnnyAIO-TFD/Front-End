	...
	if(isset($_POST['btnsave']))
	{
		...
		if(!isset($errMSG))
		{
			...
			if($stmt->execute())
			{
				...
				header("refresh:5;users.php"); // redirects image view page after 5 seconds.
			}
			else
			{
    ...
    <tr>
        ...
        <td>
			<select class="form-control" name="doc_type">
				...
				<option value="Planificadores"> Planificadores </option>
				<option value="Contadurias"> Contadurias </option>
